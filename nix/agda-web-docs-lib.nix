# The `agda-docs` CLI (agda-web-docs-lib): enhances `agda --html` output in
# place with a sidebar, full-text search, dark/light theme, hover type previews,
# line-link anchors and GitHub source links.
{ pkgs }:
...
pkgs.buildNpmPackage {
  ...
  meta = {
    description = "Enhances Agda-generated HTML documentation with interactive features";
